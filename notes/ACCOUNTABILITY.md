...
**2026-09-21 17:26 MSK.** The cds2 occupancy logger had exited cleanly at 17:02 as scheduled (`# gpu-occupancy-log exited cleanly`); restarted at 17:25 for 72 h (exits ~17:25 MSK on 24 Sep), verified writing. Log gap 17:02→17:26 on 21 Sep: do not count samples across it. At the restart: card 0 empty; card 1 `sg_sam2` plus the owner's other project (`ogs-train-…`), 10.7 GiB. Nothing of ours runs.
